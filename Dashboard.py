...
sns.barplot(x="hour", y="count", data=sum_order_items_df.head(5), palette=["#2a9df4","#2a9df4","#2a9df4","#2a9df4","#2a9df4"], ax=ax[0],edgecolor='black')
...
for p in ax[0].patches:
    ax[0].annotate(str(p.get_height()), (p.get_x() + p.get_width() / 2., p.get_height()),
                ha='center', va='center', fontsize=30, color='black', xytext=(0, 5),
                textcoords='offset points')

sns.barplot(x="hour", y="count", data=sum_order_items_df.sort_values(by="hour", ascending=True).head(5), palette=["#2a9df4","#2a9df4","#2a9df4","#2a9df4","#2a9df4"], ax=ax[1],edgecolor='black')
